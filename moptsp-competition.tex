...
\todo[inline]{game flow}

\subsection{Software}

\todo[inline]{software organization}

\subsection{Controllers}

\todo[inline]{Programming specification, API, language, pathfinding.}


\section{The MO-PTSP Competition}

\subsection{Competition format}
\todo[inline]{Infrastructure of the competition, rules}

\subsection{Submission and evaluation}

\todo[inline]{Submission, Different phases, maps. Ranking in a map, ranking in the competition}

\subsection{Sample Controllers}
